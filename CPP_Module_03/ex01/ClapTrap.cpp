...
/*   Updated: 2024/02/18 11:37:47 by haekang          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap()
: name("default"), hitPoint(100), energyPoint(50), attackDamage(20)
{
    std::cout << "ClapTrap : Default constructor called" << std::endl;
}

ClapTrap::ClapTrap(const std::string name)
: name(name), hitPoint(100), energyPoint(50), attackDamage(20)
{
